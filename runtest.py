...
from test_case_handsetadmin import test_vehicles
from test_case_handsetadmin import test_customers
...
# 报告存放路径
report_path = "/Users/kara/interfaceTest2/report"
print(report_path)
...
suite.addTest(test_collectionroutes.CollectionroutesTest('test_collectionplans_priority_patch'))
suite.addTest(test_collectionroutes.CollectionroutesTest('test_collectionplan_task_delete'))'''
...
suite.addTest(test_vehicles.VehiclesTest('test_vehicles_get'))
suite.addTest(test_vehicles.VehiclesTest('test_vehicle_RFID_post'))
suite.addTest(test_vehicles.VehiclesTest('test_vehicle_RFID_delete'))
suite.addTest(test_customers.CustomersTest('test_customers_get'))
suite.addTest(test_customers.CustomersTest('test_customers_post'))
suite.addTest(test_customers.CustomersTest('test_customers_id_get'))
suite.addTest(test_customers.CustomersTest('test_customers_put'))
suite.addTest(test_customers.CustomersTest('test_customers_RFID_post'))
suite.addTest(test_customers.CustomersTest('test_customers_RFID_delete'))
suite.addTest(test_customers.CustomersTest('test_customers_uploadimages_post'))
suite.addTest(test_customers.CustomersTest('test_customers_delete'))'''
